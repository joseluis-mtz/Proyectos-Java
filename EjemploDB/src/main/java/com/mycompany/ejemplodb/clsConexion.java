...
public class clsConexion {
    ...
    public void conectar() 
    {
        ...
        try 
        {
            ...
            // Se obtienen una instancia de conexión con la cadena de conexión a mi servidor de BD
    ...
    public void consultar(String tabla) {
        ...
        try 
        {
            ...
            while (rs.next()) {
                System.out.println((rs.getString("idPersona") + " " + rs.getString("nombre") + " "+ rs.getString("edad") + " " + rs.getString("sexo") + "\n"));
            }
            desconectar();
        } 
        catch (Exception e) 
    ...
    public void insertar(String tabla, String nombre, int edad, String sexo) {
        ...
        {
            Statement sentencia = conexion.createStatement();
            sentencia.executeUpdate("insert into " + tabla + "(nombre, edad, sexo)" + " values(" + nombre + ',' + edad  + ',' + sexo + ");");
        } 
        catch (Exception e) 
        {
    ...
    public void actualizar(String tabla, String id ,String nombre, int edad, String sexo) {
        ...
        {
            Statement sentencia = conexion.createStatement();
            sentencia.executeUpdate("UPDATE " + tabla + " set nombre = "+ nombre +", edad=" + edad + ", sexo=" + sexo+ " where idPersona="+ id+ ";");
            String sql = "UPDATE " + tabla + " set nombre = "+ nombre +", edad=" + edad + ", sexo=" + sexo+ " where idPersona="+ id+ ";";
            System.out.println(sql);
            //sentencia.executeUpdate("UPDATE" + tabla  + " values(" + nombre + ',' + edad  + ',' + sexo + ");");
        } 
        catch (Exception e) 
        {
            System.out.println("error");
